...
import os
os.environ['PATH'] += r';C:\ffmpeg-8.0.1-essentials_build\ffmpeg-8.0.1-essentials_build\bin'
import shutil
import pandas as pd
...
with st.sidebar:
    ...
    default_email = "sisodiabharti22@gmail.com"
...
with tab1:
    ...
    if not gemini_key:
        ...
        with st.spinner("Initializing system components..."):
            ...
            # Ensure DB exists
            if not os.path.exists(os.path.join(rag.index_path, "index.faiss")):
